...
from knn_pipeline.classifier_knn import KNNClassifier, get_embedder
...
def main():
    ...
    # Normalize each text for KNN (collapse newlines, spaces)
    texts = [(file, normalize_for_knn(text)) for file, text in texts]
